...
<tbody id="new_inv_item_row">
            <tr>
                ...
                <td class="td-text">
                    ...
                    <div class="input-group" id="product-no-task">
                            <span class="input-group-text"><?= $translator->translate('invoice.product'); ?></span>
                            <select name="product_id" id="product_id" class="form-control has-feedback" required>
                                 <!-- avoid using a zero option here. This forces the user to make a product selection -->
