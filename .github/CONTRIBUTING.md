...
- [Yii3-i goal and values](https://github.com/yiisoft/docs/blob/master/001-yii-values.md)
...
Since Yii-3-i consists of many packages, we have a [special development tool](https://github.com/yiisoft/docs/blob/master/005-development-tool.md).
