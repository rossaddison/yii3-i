...
$lang = [
  ...
  'invoice.client.peppol.not.found.purchase.order.line.number' => 'The Sales Order Line Number has no matching Purchase Order Line Number (OrderLineReference LineID)associated with it. The client must enter this from their side as well.',
  'invoice.client.peppol.not.found.purchase.order.item.number' => 'The Sales Order Line Item has no matching Purchase Order Line Item Identification Number (Buyers Item Identification) associated with it. The client must enter this from their side as well.',
